...
<template>
    ...
    <div class="flex min-h-screen font-sans">
        <!-- ====== LEFT: FORM PANEL ====== -->
        <div
            class="flex w-full lg:w-1/2 min-h-screen bg-white px-12 py-10 flex-col"
        >
            ...
            <!-- Form container -->
            <div
                class="flex flex-col justify-center flex-1 max-w-xs mx-auto w-full lg:mx-0 lg:ml-auto lg:mr-16 xl:mr-32"
            >
                <h2 class="text-3xl font-bold text-gray-900 mb-1">Sign up</h2>
                <p class="text-sm text-gray-400 mb-8">
                    Sign up to enjoy the feature of Wise
                </p>
                ...
                <form @submit.prevent="submit" class="flex flex-col gap-5">
                    ...
                    <div class="relative">
                        ...
                        <label
                            for="name"
                            class="absolute left-3 top-3.5 text-gray-400 text-sm transition-all duration-150 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-focus:top-1 peer-focus:text-xs peer-focus:text-blue-500 peer-[&:not(:placeholder-shown)]:top-1 peer-[&:not(:placeholder-shown)]:text-xs peer-[&:not(:placeholder-shown)]:text-gray-500"
                        >
                            Username
                        </label>
                        <InputError
        ...
        <!-- ====== RIGHT: BRAND PANEL ====== -->
        <div
            class="hidden lg:flex flex-1 relative flex-col items-center justify-center overflow-hidden bg-gray-900"
        >
            <!-- Background Image -->
            <img
            ...
            <div
                class="absolute inset-0 bg-gradient-to-b from-blue-900/60 to-gray-900/80"
            ></div>
            ...
            >
                <h1
                    class="text-6xl font-black text-white tracking-widest mb-6 drop-shadow-xl"
                >
                    WISE
                </h1>
                <p
                    class="text-xl font-medium text-gray-200 tracking-widest max-w-md drop-shadow-md"
                >
                    Warehouse Integrated Supply Evaluation
                </p>
                <p
                    class="text-sm font-light text-gray-400 tracking-widest mt-3"
                >
                    Sistem satu pintu yang menghubungkan proses verifikasi
                    penyedia barang dengan ruang penyimpanan untuk memastikan
                    setiap urusan operasional dan data inventaris Anda tersusun
