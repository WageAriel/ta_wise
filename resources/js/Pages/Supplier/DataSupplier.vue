...
<template>
    ...
    <div class="flex h-screen overflow-hidden bg-[#F8FAFC]">
        ...
        <SidebarSupplier
            class="flex-shrink-0 h-full overflow-y-auto border-r border-slate-200 shadow-sm"
        />

        <!-- Main Content (Scrollable) -->
        <main
            class="flex-1 h-full overflow-y-auto scroll-smooth bg-slate-50/20"
        >
                ...
                >
                    <div class="px-6 py-5 flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p
                                class="text-slate-600 text-sm mt-1 leading-relaxed"
                            >
                                <span
                                    v-if="props.supplier.status === 'submitted'"
                                    >Aplikasi Anda sedang dalam peninjauan oleh
                                    tim pengadaan.</span
                                >
                                <span
                                    v-else-if="
